  ...
  <div class="recharge-main">
    <div class="recharge-title">
      ...
      <div class="select-drop-main" style="margin-left: 18px">
        <span class="select-drop-span">充值状态:</span>
            ...
            >
              <div class="cp-cascader-column" style="width: 117px">
                ...
                <div class="cp-cascader-item">
                  <span class="cp-cascader-item-span">已提审</span>
                  <!---->
                </div>
                <div class="cp-cascader-item">
                  <span class="cp-cascader-item-span">已拒绝</span>
                  <!---->
                </div>
                <div class="cp-cascader-item">
                  <span class="cp-cascader-item-span">已审批</span>
                  <!---->
                </div>
                <div class="cp-cascader-item">
                  <span class="cp-cascader-item-span">已取消</span>
                  <!---->
                </div>
                <div class="cp-cascader-item">
                  <span class="cp-cascader-item-span">已完成</span>
                  <!---->
                </div>
              </div>
            </div>
    ...
    <div class="recharge-table-container p-t-0">
      <table rules="all" align="center" class="recharge-table m-t-0 p-t-0">
        <tr align="center" class="recharge-table-header">
          <th height="40" width="160">充值单号</th>
          <th height="40" width="100">充值金额</th>
          <th height="40" width="100">USDT数量</th>
          <th height="40">备注说明</th>
          <th height="40" width="80">状态</th>
          <th height="40" width="150">创建时间</th>
          <th height="40" width="80">操作</th>
        </tr>
        <tr align="center" class="table-lose">
          <td height="32" width="160">7117101523345572864</td>
          <td height="32" width="100">7080.00</td>
          <td height="32" width="100">1000</td>
          <td height="32" align="left"></td>
          <td height="32" width="80">待付款</td>
          <td height="32" width="150">2024-11-15 21:49:10</td>
          <td height="32" width="50px;">
            <span>--</span>
          </td>
        </tr>
      </table>
